...
export const register = async (req, res) => {
  ...
  try {
    ...
    const  userFound = await User.findOne({email}) //Verificar si el usuario
    ...
    const userSaved = await newUser.save(); //recordar usar async cuando se use await
    ...
    res.json({
       id: userSaved._id,
       username: userSaved.username, //solicitando informacion excat a recibir
